...
(async () => {
    ...
    modelo = await tf.loadLayersModel("/paginaClasficacionBasura/model.json");
...
function predecir() {
    if (modelo != null) {
        ...
        for (var p=0, i=0; p < imgData.data.length; p+=4) {
            ...
            arr150.push([(r+g+b)/3]); //Agregar al arr150 y normalizar a 0-1. Aparte queda dentro de un arreglo en el indice 0... again
            if (arr150.length == 200) { //150
                arr.push(arr150);
                arr150 = [];
            }
        }
        ...
        var clases = ['Organico', 'Inorganico'];
